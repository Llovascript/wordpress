...
class Khobish_Helper { 
	...
	static function pagination(){
	    return array(
	        '' => esc_html__('No Pagination', 'news-element') ,
	        'load_more' => esc_html__('Load more', 'news-element') ,
	        'prev_next' => esc_html__('Prev next', 'news-element') ,
			'numeric' => esc_html__('Numeric', 'news-element') ,
	    );  
	}
	...
	static function fashmag_comment(){
	    if ( ! post_password_required() ) {
	        ...
	        return '<span class="post-comment leffect-1"><i class="bi-chat-text" aria-hidden="true"></i> '.$write_comments.'</span>';
	    }   
	}
	...
	static function khobish_author(){
	        ...
	        return'<span class="post-meta-author leffect-1">
	            <span class="meta-author-name"><span class="bi-person-check" aria-hidden="true"></span> '.get_the_author_posts_link().'</span>
	        </span>';
	}
	...
	static function khobish_post_title_nolink(){
	        ...
	        $id= $post->ID;
	        $fletter = get_the_title($id)[0]; 
	        return '<h3 class="entry_title" data-first="'.$fletter.'"><a class="no-link" title="'.get_the_title($id).'" href="javascript:void(0)">'.get_the_title($id).'</a></h3>';
	}
	...
	static function xl_ajax_pagination($type,$count,$found){
        ...
        switch ($type) {      
            case "prev_next":
                return '<div class="khobish_pagination prev-next" data-post-count="'.esc_attr($count).'" data-post-found="'.esc_attr($found).'"><div class="mz_prev"><a href="#" class="prev inactive"><i class="bi-chevron-left" aria-hidden="true"></i></a></div><div class="middle-bar"><span></span></div><div class="mz_next"><a href="#" class="next"><i class="bi-chevron-right" aria-hidden="true"></i></a></div></div>';   
                break;

            case "load_more":
                return '<div class="khobish_pagination load-more" data-post-count="'.esc_attr($count).'" data-post-found="'.esc_attr($found).'"><div class="mz_next"><a href="#" class="next"><span>Load More</span> <i class="bi-arrow-clockwise"></i></a></div></div>'; 
                break;
