...
class khobish_magazine21 extends Widget_Base {
	...
	protected function register_controls() {
        ...
        do_action('newsmag_flex_list', $this,'s2_','.bgtitle .post-item');
        ...
        do_action('newsmag_flex_list', $this,'s1_','.smtitle .post-item');
        ...
        do_action('newsmag_post_title_style', $this,'rut_','.bgtitle .entry_title');
        ...
        do_action('newsmag_post_title_style', $this,'md_','.smtitle .entry_title');
