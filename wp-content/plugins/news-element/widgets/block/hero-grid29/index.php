...
class news_element_herogrid29 extends Widget_Base {
    ...
    public function get_title() {
        return __('Hero Grid 29', 'news-element');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .inrwrp' => 'border-radius: {{SIZE}}{{UNIT}};',                  
                ],
            ]
        );
        ...
        do_action('newsmag_flex_list', $this,'fst_','.firstblock .post-item');
        ...
        do_action('newsmag_flex_list', $this,'sny_','.secondblock .post-item');
        ...
        do_action('newsmag_overlay_tax_style', $this,'ovct_');
        ...
        do_action('newsmag_post_meta_style', $this,'.light-meta');
