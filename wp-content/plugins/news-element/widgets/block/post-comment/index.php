    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .khb-commentwrap .khbcomhead,{{WRAPPER}} .comment-reply-title' => 'color: {{VALUE}};',
                ],
            ] 
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .khb-commentwrap .khbcomhead,{{WRAPPER}} .comment-reply-title',
            ]
        );
        ...
        $this->add_responsive_control(
          ...
          [
             ...
             'size_units' => [ 'em','px'],
             'selectors' => [
                    '{{WRAPPER}} .khb-commentwrap .khbcomhead,{{WRAPPER}} .comment-reply-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
             ],
          ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::NUMBER,
                 'selectors' => [
                        '{{WRAPPER}} .cformwrap .khbcomment-field' => 'flex:0 0 {{VALUE}}%;width:{{VALUE}}%;',
                 ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .cformwrap' => 'margin: 0 0 -{{SIZE}}{{UNIT}} -{{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .cformwrap .khbcomment-field' => 'padding: 0 0 {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}};',  
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .form-control' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .submit' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px'],
                'selectors' => [
                    '{{WRAPPER}} .submit' => 'border-width: {{SIZE}}{{UNIT}};border-style:solid',
                ],
