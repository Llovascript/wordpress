...
<div class="ne-social-profile style-two ne-d-flex ne-gutter">
    ...
    foreach ($settings['lists'] as $a) {
        ...
        echo '<div class="ne-df-50"><a class="ne-d-flex ne-v-center ne-dir-col elementor-repeater-item-' . $a['_id'].'" ' . Khobish_Helper::render_link($a['url']) . '>'.$icon.'<span class="social-left ne-d-flex ne-dir-col">'.$sub.$count.'</span></a></div>';
        ?> 
        <?php
    } ?>
