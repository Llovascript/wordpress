    ...
    protected function register_controls() {
        ...
        $r1->add_control(
            'color', [
                ...
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .taxnum' => 'background: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '100',
                 'selectors' => [  
                        '{{WRAPPER}} .ne-gutter .ne-df-100' => 'flex:0 0 {{VALUE}}%;width:{{VALUE}}%;',
                 ],
            ] 
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ne-gutter>a[class^="ne-df-"]' => 'padding: 0 0 {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}};',                    
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .pos-rel:after',
            ]
        );
        ...
        $this->add_responsive_control(
            'itpd',
            [
                'label' => esc_html__('Item padding', 'thepackpro'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .pos-rel' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .pos-rel' => 'border-radius:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .taxnum' => 'width:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .taxnum' => 'height:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' =>  Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .taxnum' => 'border-radius:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
